...
const title = titles;
const props = defineProps<FilterPageProps>();

const deal_endpoints = {
  nearby: '/discover/nearbyDeals',
  restaurants: '/discover/restaurantDeals',
  hotels: '/discover/hotelDeals',
} as const;

const category_endpoints = {
  nearby: '/discover/nearbyCategories',
  restaurants: '/discover/restaurantCategories',
  hotels: '/discover/hotelCategories',
} as const;

const dealEndpoint = computed(() => deal_endpoints[props.pageType]);
const categoryEndpoint = computed(() => category_endpoints[props.pageType]);

const { data: categoryData } = await useFetch(categoryEndpoint, {
...
const { data: apiDeals } = await useFetch(dealEndpoint, {
  default: () => [],
